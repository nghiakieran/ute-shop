    ...
    <footer className="bg-neutral-900 text-neutral-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-neutral-400">
              Thời trang phong cách Tây hiện đại, sang trọng và tối giản.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-4 py-2 bg-neutral-800 border border-neutral-700 rounded-l-lg focus:outline-none focus:border-neutral-500 text-sm"
              />
              <button className="px-4 py-2 bg-white text-neutral-900 rounded-r-lg hover:bg-neutral-100 transition-colors text-sm font-medium">
                Đăng ký
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-neutral-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-neutral-400">
            © {currentYear} UTEShop. All rights reserved.
          </p>
